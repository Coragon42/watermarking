...
# watermarked = '.\data\Adaptive\Adaptive,facebook-opt-1.3b,2.0,0.5,300,None,None,0.9,6.0,0,200,v0.jsonl'
# unwatermarked = '.\data\Adaptive\Adaptive,facebook-opt-1.3b,0,0.5,300,None,None,0.9,6.0,0,200,v0.jsonl'

watermarked = '.\data\OpenGen\OpenGen,baffo32-decapoda-research-llama-7B-hf,2.0,0.5,300,None,None,0.9,6.0,0,200,v0.jsonl'
unwatermarked = '.\data\OpenGen\OpenGen,baffo32-decapoda-research-llama-7B-hf,0,0.5,300,None,None,0.9,6.0,0,200,v0.jsonl'
